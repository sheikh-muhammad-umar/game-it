$(function() {
    ...
    var k = new Chartist.Line(".stats", {
        labels: ["Visual", "Spatial", "Memory", ""],
        series: [
            [14, 36, 12, 18]
        ]
    }, { low: 0, high: 50, showArea: !0, fullWidth: !0, plugins: [Chartist.plugins.tooltip()], axisY: { onlyInteger: !0, scaleMinSpace: 40, offset: 20, labelInterpolationFnc: function(e) { return e / 1 + "k" } } });
