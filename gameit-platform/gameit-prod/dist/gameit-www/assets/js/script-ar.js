...
(function() {
    ...
    $(function() {
        ...
        function attachFormValidator(elements) {
            ...
            regula.custom({
                name: 'PhoneNumber',
                defaultMessage: 'تنسيق رقم الهاتف غير صالح',
                validator: function() {
            ...
            var regularConstraintsMessages = [{
                    ...
                    newMessage: "حقل إلزامي"
                },
                {
                    type: regula.Constraint.Email,
                    newMessage: "يرجى إعادة إدخال بريدك الإلكتروني بشكل صحيح.."
                },
                {
...
$(document).ready(function() {
    ...
    /*
          if (document.cookie.indexOf("announce=true") == -1) {
              document.cookie = "announce=true; max-age=43200"; // 86400: seconds in a day
              $("#insModal").modal('show');
          }
      */
