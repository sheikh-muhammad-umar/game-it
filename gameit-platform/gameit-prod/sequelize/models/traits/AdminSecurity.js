...
const AdminHash = require('./../../../utils/security/admin');

/**
 * security trait for sequelize admin model
 * @mixin AdminSecurityTrait
...
module.exports = model => {
  ...
  const params = {
    ...
    passwordResetTokenExpire: 3600 * 24, // 3600 = 1 hour
   ...
   * @name AdminSecurityTrait#validatePassword
   ...
   * @name AdminSecurityTrait.findByPasswordResetToken
   ...
   * @name AdminSecurityTrait.isPasswordResetTokenValid
   * @param {string} token - Password reset token
  ...
  model.isPasswordResetTokenValid = ( token, options = {} ) => {
    ...
    return expire > AdminHash.time();
  };
  
  /**
   * @public
   * Removes password reset token
   * @name AdminSecurityTrait#removePasswordResetToken
   */
  model.prototype.removePasswordResetToken = function () {
	...
	/**
   * @public
   * @name AdminSecurityTrait#getAuthKey
  ...
  model.prototype.getAuthKey = function () {
	...
	/**
   * @public
   * @name AdminSecurityTrait#validateAuthKey
  ...
  model.prototype.validateAuthKey = function ( authKey ) {
	...
	/**
   * @public
   * @name AdminSecurityTrait#generateAuthKey
   * Generates token authentication key
   */
  model.prototype.generateAuthKey = function () {
    this.set('authKey', AdminHash.generateAuthKey());
  };
};
