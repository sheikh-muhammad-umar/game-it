...
export class AppComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    this.isLoggedIn = !!this.cookiesStorageService.getCookie('authToken');
    // console.log("getCookie('authToken'): ", this.cookiesStorageService.getCookie('authToken'));
  ...
  ngOnInit(): void {
    if (this.isLoggedIn) {
      this.user = this.serverCallsService.getUser().valueChanges.subscribe({
        next: (data: any) => {
          // console.log(data.data.me);
          
          this.user = data.data.me;
          this.userStore.dispatch(userRecord({ userRecord: data.data.me }));
  ...
  logout(): void {
    this.cookiesStorageService.removeCookie('authToken');
